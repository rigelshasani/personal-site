...
export const metadata: Metadata = {
  title: { default:"Rigels · Thoughts & Analytics", template:"%s · Rigels" },
    ...
    <html lang="en">
      <body className="antialiased bg-bg text-text-high">
        <header className="mx-auto max-w-6xl px-6 py-6 flex items-center">
          <a href="/" className="font-semibold tracking-tight">Rigels</a>
        </header>
        <main className="mx-auto max-w-6xl px-6">{children}</main>
        <footer className="mx-auto max-w-6xl px-6 py-10 text-sm text-text-mid">
          ©{new Date().getFullYear()} Rigels Hasani
        </footer>
        {/* thin progress bar */}
        <script
